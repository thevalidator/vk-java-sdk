...
public class CustomHttpTransportClient implements TransportClient {

    protected static final Logger LOG = LoggerFactory.getLogger(CustomHttpTransportClient.class);

    protected static final String ENCODING = "UTF-8";
    protected static final String FORM_CONTENT_TYPE = "application/x-www-form-urlencoded";
    protected static final String CONTENT_TYPE_HEADER = "Content-Type";
    protected static final String DEFAULT_USER_AGENT = "Java VK SDK/1.0";
    ...
    protected static CustomHttpTransportClient instance;
    protected static HttpClient httpClient;

    protected int retryAttemptsNetworkErrorCount;
    protected int retryAttemptsInvalidStatusCount;

    public CustomHttpTransportClient(String userAgent, Proxy proxy) {
        this(DEFAULT_RETRY_ATTEMPTS_NETWORK_ERROR_COUNT, DEFAULT_RETRY_INVALID_STATUS_COUNT, userAgent, proxy);
    }

    public CustomHttpTransportClient(int retryAttemptsNetworkErrorCount, int retryAttemptsInvalidStatusCount, String userAgent, Proxy proxy) {

        this.retryAttemptsNetworkErrorCount = DEFAULT_RETRY_ATTEMPTS_NETWORK_ERROR_COUNT;
        this.retryAttemptsInvalidStatusCount = DEFAULT_RETRY_INVALID_STATUS_COUNT;
        ...
        if (proxy != null) {
            HttpHost proxyHost = new HttpHost(proxy.getAdress(), proxy.getPort());
            //Client credentials for proxy
...
//                .setDefaultCredentialsProvider(credentialsProvider);
        ...
        httpClient = builder
                ...
                .setUserAgent((userAgent == null || userAgent.isEmpty()) ? DEFAULT_USER_AGENT : userAgent)
                .build();
    }
